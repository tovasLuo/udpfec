 ...
 */
void cli_print(struct cli_def *cli, const char *format, ...) ATTRIBUTE((format(printf, 2, 3)));
 ...
 * @param[in]  <unnamed>  related printf-style continuation
 */
void cli_bufprint(struct cli_def *cli, const char *format, ...) ATTRIBUTE((format(printf, 2, 3)));
 ...
 * @param[in]  <unnamed>  related printf-style continuation
 */
void cli_error(struct cli_def *cli, const char *format, ...) ATTRIBUTE((format(printf, 2, 3)));
 ...
 * @param[in]  privilege        target privilege for the optional argument
